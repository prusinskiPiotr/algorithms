...
def intcode_computer(input_list):
    ...
    while input_list[n] != 99:
        ...
        if opcode == 1:
            ...
            print(input_list[n], input_list[n+1], input_list[n+2], input_list[n+3])
            try: 
                param1 = instruction[-3]
            except IndexError:
                param1 = 0
            try: 
                param2 = instruction[-4]
            except IndexError:
                param2 = 0
            try: 
                param3 = instruction[-5]
            except IndexError:
                param3 = 0
            # print(param1, param2, param2)
            # print(input_list[n], input_list[n+1], input_list[n+2], input_list[n+3])
            # print(input_list[input_list[n+1]])
            if param1:
                # print(param1_val)
                param1_val = input_list[n+1]
            else:
                param1_val = input_list[input_list[n+1]]
            if param2:
                param2_val = input_list[n+2]
            else:
                param2_val = input_list[input_list[n+2]]
            # if param3:
            #     param3_val = input_list[n+3]
            # else:
            #     param3_val = input_list[input_list[n+3]]
            ...
            input_list[input_list[n+1]] = 1
            n += 2
        elif opcode == 4:
            n += 2
    return input_list

intcode_computer(initial_list)
